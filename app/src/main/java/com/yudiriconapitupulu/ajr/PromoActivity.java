...
public class PromoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.home:
                        ...
                        startActivity(i);
                        //startActivity(new Intent(PromoActivity.this, HomeActivityCustomer.class));
                    ...
                    case R.id.profile:
                        ...
                        i.putExtra("tempID", id);
                        startActivity(i);
                        //startActivity(new Intent(PromoActivity.this, ProfileCustomerActivity.class));
                        overridePendingTransition(0,0);
                        finish();
                        return true;
                    case R.id.logout:
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT){
            ...
            rvPromo.setLayoutManager(new GridLayoutManager(PromoActivity.this, 2));
        }
