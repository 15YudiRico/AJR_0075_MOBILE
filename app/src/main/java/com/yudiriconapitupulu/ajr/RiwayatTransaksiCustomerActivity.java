...
public class RiwayatTransaksiCustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riwayat_transaksi_customer);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.home:
                        i = new Intent(RiwayatTransaksiCustomerActivity.this, HomeActivityCustomer.class);
                        ...
                        return true;
                    case R.id.b_mobil:
                        i = new Intent(RiwayatTransaksiCustomerActivity.this, BrosurActivity.class);
                        i.putExtra("tempID", id);
                        startActivity(i);
                        ...
                        return true;
                    case R.id.promo:
                        i = new Intent(RiwayatTransaksiCustomerActivity.this, PromoActivity.class);
                        i.putExtra("tempID", id);
                        startActivity(i);
                        ...
                        return true;
                    case R.id.profile:
                        i = new Intent(RiwayatTransaksiCustomerActivity.this, ProfileCustomerActivity.class);
                        i.putExtra("tempID", id);
                        startActivity(i);
                        //startActivity(new Intent(ProfileCustomerActivity.this, PromoActivity.class));
                        overridePendingTransition(0,0);
        ...
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT){
            ...
            rvTransaksi.setLayoutManager(new GridLayoutManager(RiwayatTransaksiCustomerActivity.this, 1));
        }else{
            //Grid Layout Landscape
            rvTransaksi.setLayoutManager(new GridLayoutManager(RiwayatTransaksiCustomerActivity.this, 2));
        }
    ...
    private void getAllTransaksi(long id) {
        ...
        StringRequest stringRequest = new StringRequest(GET, "https://atmajayarental.site/api/transaksi/"+id, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(RiwayatTransaksiCustomerActivity.this, transaksiResponse.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                try {
                    ...
                    Toast.makeText(RiwayatTransaksiCustomerActivity.this, errors.getString("message"), Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(RiwayatTransaksiCustomerActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        }) {
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        startActivity(new Intent(RiwayatTransaksiCustomerActivity.this, MainActivity.class));
                        overridePendingTransition(0, 0);
                        finish();
                    }
                })
